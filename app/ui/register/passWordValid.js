function ValidShow({ele}) {
    return(<div className="flex flex-col justify-center items-center">
        <div className="bg-white bg-opacity-80 rounded-xl px-4">
            ...
            {/[!@#$%&]/.test(ele) ? <p className="text-green-600 text-center w-full truncate font-bold">Eg. !, @, #, $, %, &</p> : <p className="text-red-700 text-center w-full truncate font-bold">Eg. !, @, #, $, %, &</p>}
        </div>
    </div>);
}
